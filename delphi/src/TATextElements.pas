...
uses
  Classes, Graphics, Types, TAChartUtils, TADrawUtils, TATypes,
  Math, SysUtils, TACustomSource, TAGeometry;
...
type
  ...
  TGenericChartMarks<_TLabelBrush: TBrush, constructor;
    _TLinkPen: TChartPen, constructor;
    _TFramePen: TChartPen, constructor> =
  ...
  {$IFNDEF fpdoc}  // Workaround for issue #18549.
  TCustomChartMarks =
    TGenericChartMarks<TChartLabelBrush, TChartLinkPen, TChartPen>;
  {$ENDIF}
...
begin
  ...
  for i := 0 to High(labelPoly) do
    labelPoly[i] := labelPoly[i] + ALabelCenter;
  ...
  case FRotationCenter of
    rcCenter: P := DivPoint(NegPoint(ptText), 2);
    rcEdge,
    rcLeft  : begin
...
begin
  ...
  FAlignment := taCenter;
  FBrush := InitHelper<TBrush>;
  FBrush.Color := FOwner.Color;
  FFont := InitHelper<TFont>;
  FFont.Color := clBlue;
  FFrame := InitHelper<TChartTitleFramePen>;
  FMargin := DEF_MARGIN;
...
begin
  if not Visible or (Text.Count = 0) then exit;
  ptSize := SizeToPoint(MeasureLabel(ADrawer, Text.Text));
  case Alignment of
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.ApplyLabelFont(ADrawer: IChartDrawer);
begin
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.Assign(ASource: TPersistent);
begin
  if ASource is Self.ClassType then
    with TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>(ASource) do begin
...
function TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.CenterHeightOffset(
  ADrawer: IChartDrawer; const AText: String): TSize;
var
  d: Integer;
begin
  d := ADrawer.Scale(Distance);
  Result := Size(d, d) + DivSize(MeasureLabelHeight(ADrawer, AText), 2);
end;

function TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.CenterOffset(
  ADrawer: IChartDrawer; const AText: String): TSize;
var
  d: Integer;
begin
  ...
  if not DistanceToCenter then
    Result := Result + DivSize(MeasureLabel(ADrawer, AText), 2);
end;

constructor TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.Create(AOwner: TCustomChart);
begin
  inherited Create(AOwner);
  FArrow := TChartArrow.Create(AOwner);
  FAutoMargins := true;
  FFrame := InitHelper<_TFramePen>;
  FLabelBrush := InitHelper<_TLabelBrush>;
  FLabelFont := InitHelper<TFont>;
  FLinkPen := InitHelper<_TLinkPen>;
  FStyle := smsNone;
  FVisible := true;
end;

destructor TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.Destroy;
begin
  FreeAndNil(FArrow);
  FreeAndNil(FFrame);
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.DrawLink(
  ADrawer: IChartDrawer; ADataPoint, ALabelCenter: TPoint);
var
  phi: Double;
begin
...
function TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.GetDistanceToCenter: Boolean;
begin
  Result := Attachment = maCenter;
end;

function TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.GetFrame: TChartPen;
begin
  Result := Frame;
end;

function TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.GetLabelAngle: Double;
begin
  Result := inherited GetLabelAngle - FAdditionalAngle;
end;

function TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.GetLabelBrush: TBrush;
begin
  Result := LabelBrush;
end;

function TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.GetLabelFont: TFont;
begin
  Result := LabelFont;
end;

function TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.GetLinkPen: TChartPen;
begin
  Result := LinkPen;
end;

function TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.IsMarkLabelsVisible: Boolean;
begin
  Result := Visible and (Style <> smsNone) and (Format <> '');
end;

procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetAdditionalAngle(AAngle: Double);
begin
  FAdditionalAngle := AAngle;
end;

procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetArrow(AValue: TChartArrow);
begin
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetAttachment(AValue: TChartMarkAttachment);
begin
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetAutoMargins(AValue: Boolean);
begin
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetDistance(AValue: TChartDistance);
begin
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetDistanceToCenter(AValue: Boolean);
begin
  if AValue then
    Attachment := maCenter
  else
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetFormat(AValue: String);
begin
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetFrame(AValue: _TFramePen);
begin
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetLabelBrush(AValue: _TLabelBrush);
begin
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetLabelFont(AValue: TFont);
begin
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetLinkDistance(AValue: Integer);
begin
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetLinkPen(AValue: _TLinkPen);
begin
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetStyle(AValue: TSeriesMarksStyle);
begin
...
procedure TGenericChartMarks<_TLabelBrush, _TLinkPen, _TFramePen>.SetYIndex(AValue: Integer);
begin
