...
var
  totalRepeatCount: Cardinal;
  i: Integer;
begin
  totalRepeatCount := 0;
  Result := nil;
  for i := 0 to Styles.Count - 1 do
    totalRepeatCount := totalRepeatCount + Styles[i].RepeatCount;
  ...
  for i := 0 to Styles.Count - 1 do begin
    Result := Styles[i];
    totalRepeatCount := totalRepeatCount + Result.RepeatCount;
