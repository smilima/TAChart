...
{$HPPEMIT '#pragma link "TATransformations"'}
...
type
  ...
  TAxisTransformEnumerator = TTypedFPListEnumerator<TAxisTransform>;
  {$ENDIF}
...
var
  // Exposed for the design-time package, which enumerates the registered
  // transformation classes; Lazarus keeps this in the implementation section
  // because its editors live in this unit.
  AxisTransformsClassRegistry: TClassRegistry;

implementation

uses
  Math, TAChartStrConsts, TAMath;
...
begin
  System.Classes.RegisterClass(AAxisTransformClass);
